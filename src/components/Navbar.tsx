...
const Navbar = () => {
  ...
  return (
    <Menu setActive={setActive}>
      <Link to="/" className="text-lg md:text-xl font-bold text-primary mr-4 md:mr-8">
        ResumeAI
      </Link>
      <MenuItem 
        setActive={setActive} 
      ...
      <StarBorder as={Link} to="/contact" className="cursor-pointer mx-2 md:mx-6" speed="4.5s">
        Contact Us
      </StarBorder>
